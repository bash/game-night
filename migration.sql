...
INSERT INTO users_ SELECT id, name, role, '' as symbol, email_address, email_subscription, invited_by, campaign, can_update_name, can_answer_strongly, created_at, last_active_at FROM users;
DROP TABLE users;
